/** About 頁文案 · accent 欄位為 6:3:1 點睛（約 10%） */
...
export const ABOUT_FOUNDER = {
  ...
  paragraphs: [
    ...
    },
    {
      parts: [
        ...
        { t: '，以及策展人的' },
        { t: '美學語言', accent: true },
        { t: '。寫程式讓我知道，一個好的產品不只是功能好，是要讓人願意去使用；做策展讓我知道，一個好的作品不只是做得好，是要讓人願意走得進去、待下來。' },
      ],
    },
    {
      parts: [
  ...
  traits: ['軟體工程 · 10 年', '策展 · 10+ 檔展覽', '系統思維 × 美學語言'],
}
  ...
  items: [
    {
      ...
      desc: '深度梳理你的核心信念、世界觀與敘事弧，讓你第一次真正看見自己。',
    },
    {
      num: '02',
      title: '品牌建構',
    ...
    },
    {
      ...
      title: '系統延伸',
      en: 'System Extension',
      desc: '社群、官網、影像——所有對外溝通的介面，都從同一個源頭長出來，保持一致的氣質。',
    },
  ],
}
  ...
  items: [
    {
      ...
      desc: {
        parts: [
          { t: '包裝可以複製，' },
          { t: '人格', accent: true },
          { t: '無法複製。我們在做的是讓你成為自己，而不是成為別人期待的樣子。' },
        ],
      },
    },
    {
      num: '02',
      title: '高級感來自一致性',
      desc: '視覺、文案、互動、回應——全部都是品牌的一部分。連看不見的地方，都應該被設計。',
    },
    {
      num: '03',
      title: '成為有力量的角色',
      desc: {
        parts: [
          { t: '當你真正活出自己的核心，吸引力自然發生。品牌不是你的名片，是你讓別人' },
          { t: '願意靠近', accent: true },
          { t: '的理由。' },
        ],
      },
...
export const ABOUT_QUOTE = {
  lines: [
    {
      parts: [{ t: '當你成為一個' }, { t: '有力量的角色', accent: true }, { t: '，' }],
    },
    '現實裡會有一萬個人，',
    '想跟你擁有一樣的能量。',
  ],
...
export const ABOUT_CTA = {
  ...
  title: [
    '如果你準備好',
    {
      parts: [{ t: '被世界' }, { t: '正確看見', accent: true }],
    },
  ],
